    ...
    <>
      ...
      <Container id="about-section" maxWidth="lg">
        <AboutSection sx={{ width: isMobile ? '95%' : '75%', margin: '0 auto' }}>
          ...
          <Typography variant="body1" paragraph>
            Based in El Salvador, Surfpik connects surfers with photographers, creating a seamless experience for everyone involved. We’re proud to be rooted in the heart of the Central American surf scene and are aspiring to expand our reach across the region, making it easier for surfers and photographers all over Central America to connect and share unforgettable moments.
          </Typography>
        </AboutSection>
